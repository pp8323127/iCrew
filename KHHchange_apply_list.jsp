        ...
        $(document).ready(function () {
            ...
            $("#sub").click(function(e){
            	...
            	if("" != yymm && (!isNaN(aEmpnoArr) || !isNaN(rEmpnoArr)) ){
                	...
                	$("#swapDetailform").attr("action", "KHHchange_apply_finalcheck.jsp");
			...
			$("#naviBar_icon_Back").click(function(e){
            	...
            	var rEmpno = $("#rEmpno").val();
            	if("" != yymm && ""!=rEmpno ){
	            	$("#swapDetailform").attr("action", "KHHchange_apply_substitle.jsp");
					$("#swapDetailform").submit();
            	}else{
...
csf.SwapSkjKHH(aEmpno, rEmpno, year, month);
...
<%				
		...
		%>
		    <!-- <script type="text/javascript">
		       	$("#swapDetailform").attr("action", "change_apply_list.jsp");
				$("#swapDetailform").submit();
		    </script> -->	
		<%
		}
