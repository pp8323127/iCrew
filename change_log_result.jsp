...
<%
	...
	swap3ac.ShowSwapForm aform = null;
	swap3ac.ShowSwapBForm bform = null;
	...
	if("TPE".equals(uObj.getBase()) && null != formno && !"".equals(formno)){
		if("A".equals(type)){
			aform = new swap3ac.ShowSwapForm(formno);
			obj= aform.getSwapFormObj();
		}else if("B".equals(type)){
			bform = new swap3ac.ShowSwapBForm(formno);
...
<%
		...
		/*else if("KHH".equals(uObj.getBase())) {
			response.sendRedirect("KHHchange_log_result.jsp?type=A&formno="+formno);			
		}*/
		else{
