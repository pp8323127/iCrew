...
<head>
    ...
    <script type="text/javascript">
        ...
        function addEmpno(){
  	  		...
  	  		if(countR == 0){
  	  			$("#divEmpno:last").append("<div class='inputEMP_calc'><input type='text' name ='rEmpno' id='employee"+countR+"'  maxlength='6'>");
  	  			//$("#employee"+countR).collapsibleset();
				$("#divEmpno:last").trigger('create');
  	  		}else if(countR > 0 && countR < 3){
       			$("#divEmpno:last").append("<div class='inputEMP_calc'><input type='text' name ='rEmpno' id='employee"+countR+"' maxlength='6'><div id='del"+countR+"' class='delEmpno' onClick='delEmpno(\"employee"+countR+"\",\"del"+countR+"\")'></div></div>");
       			//$("#employee"+countR).collapsibleset();
				$("#divEmpno:last").trigger('create');
        	}else{
        		$("#strMsg").html("試算者至多三位");
		...
		<table id="header-bar">
			<tr>
				<td id="header-bar-btnBak">
					<a href="change_main.jsp"><div id="naviBar_icon_Back"></div></a>
				</td>
