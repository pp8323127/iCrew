...
try{
	...
	//out.println(apoint+"/"+rpoint+"/"+ack+"/"+rck+"/"+aTimes+rTimes);
	String year = "";
	String month = "";
	String str = "";
	int totalTimes = 4;
    ...
    <script type="text/javascript">
        $(document).ready(function () {
          ...
          //submit
			...
			//back
			$("#naviBar_icon_Back").click(Cancel);
			$("#cancel").click(Cancel);
        });
        ...
        function Cancel(e){
        	...
        	var rEmpno = $("#rEmpno").val();
        	if("" != yymm && ""!=rEmpno ){
            	$("#swapSendform").attr("action", "KHHchange_apply_list.jsp");
				$("#swapSendform").submit();
        	}else{
...
<div role="main" class="ui-content">
	<form id="swapSendform" method="POST" action="" data-ajax="false">
		...
		<%}%>
		<div id="btnOKCancel">
			<a id="cancel" class="ui-btn ui-corner-all" data-ajax="false"><div>取消</div></a>
