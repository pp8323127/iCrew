...
<body class="main">
<div id="choose_main" class="main" data-role="page">
<!-- Header bar Start -->
        ...
        <div id="main-content">
            ...
            <div>
             <%if(cabin && ("TPE".equals(uObj.getBase()) || "KHH".equals(uObj.getBase()))  ){//&& "1".equals(uObj.getstatus)%>
                <a href="choose_apply.jsp" class="ui-btn ui-nodisc-icon ui-btn-icon-right ui-icon-menu_btn_arrow_right_white" data-ajax="false">選班資格申請</a>
                <hr/>
             <%if("TPE".equals(uObj.getBase())  ){%>
                <a href="choose_reserve.jsp" class="ui-btn ui-nodisc-icon ui-btn-icon-right ui-icon-menu_btn_arrow_right_white" data-ajax="false">選班預約申請</a>
                <hr/>
                <a href="choose_progress.jsp" class="ui-btn ui-nodisc-icon ui-btn-icon-right ui-icon-menu_btn_arrow_right_white" data-ajax="false">處理進度查詢</a>
                <hr/>
             <%}
                }else{%> 
