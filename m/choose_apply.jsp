...
<head>
    ...
    <script type="text/javascript">
            ...
            $("#sub").click(function(e){
            	...
            	if((att != "" || count == 3) && !(att != "" && count >= 3)){
            		if(att !=""){
            			...
            			edate = $("#edate").val();
            			comment = $("#comment").val();
            			console.log(sdate +"/"+ edate +"/"+ comment); 
            		}else if(count == 3){
            			type = 2;
            		}
            		$.ajax({
        ...
        function PopFunction(sdate,edate,comment){
        	$("#info1").html(sdate+"~"+edate +","+comment);
    	};
    </script>
	...
	<div role="main" class="ui-content">
		...
		<table id="choose-serv-t">
			...
			<tr>
				...
				<input type="hidden" name="sdate"  id="sdate" value="<%=aObj[i].getCheck_range_start()%>">
				<input type="hidden" name="edate"  id="edate" value="<%=aObj[i].getCheck_range_final_end()%>">
...
<div data-role="popup" id="alert-popup-info" class="ui-content popupDiv" data-overlay-theme="b" data-dismissible="false" data-position-to="#popupSite" data-shadow="true" data-corners="true">
    ...
    <div data-role="content" class="popup-content">
        <p id="info1"></p><!-- 2015/03/01-2015/06/30, 122 days (留停) -->
